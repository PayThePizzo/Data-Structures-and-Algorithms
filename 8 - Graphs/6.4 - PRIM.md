...
2. We perform a cut and update the data inside Q.
   ...
   * At every iteration we stop updating certain vertices and pop them out of Q.
3. We repeat until Q is empty. 
   1. A is simply the set of edges in E, (u,π[u]) such that u is in V\{r}.
