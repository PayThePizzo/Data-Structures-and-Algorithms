...
Finding the minimum of a set equals finding the minimum out of all its partitions. Therefore, our original problem can be decomposed as $\min \left\{ X \right\} = \min \left\{ \min \left\{ Y \right\}  \,, \min \left\{ Z \right\} \right\}$.
